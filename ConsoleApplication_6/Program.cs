...
class Sample
{
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            else
            {
                ...
                if (Password.Length >= 1)
                {
                    ...
                    Password = Password.Substring(0, oldLength - 1);
                    Console.CursorLeft = 0;
                    Console.CursorTop = Console.CursorTop - extraRows;
                    Console.Write(Password + new String(' ', oldLength - Password.Length));
    ...
    public static void Main()
    {
        ...
        //Console.Write("CursorLeft :{0}, CursorTop :{1} : ",Console.CursorLeft,Console.CursorTop);
        //Sample.Password();
        //Environment.Exit(0);
